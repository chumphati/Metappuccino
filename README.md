...
| `--model [--gguf]`       | str, **required if `--fillmetadata`**                                             | Path to model (e.g., `.../model.gguf` or HF model path used by your scripts). If gguf model used, add `--gguf`                                                                                                 |
...
| `--ncbi_email`           | str, default `None`                                                               | Email submission for SRA/NCBI downloads.                                                                                                                                                                       |
| `--ncbi_api_key`         | str, default `None`                                                               | NCBI key for SRA/NCBI downloads. If a key is provided, download will be up to 2 times faster.                                                                                                                  |
...
| `--logan_path`           | str, default `""`                                                                 | Additional metadata extracted from Logan search (`ID` column expected with run accession number). Can be used for other additionnal metadata than Logan.                                                       |
...
Sequence Read Archive Metadata for Cancer Research](https://www.biorxiv.org/content/10.1101/2025.10.31.685769v1)
