...
train_input = '/store/EQUIPES/SSFA/MEMBERS/fiona.hak/Metappuccino/results_ft_patron_semi/train_metadata_replaced_table.csv'
val_input   = '/store/EQUIPES/SSFA/MEMBERS/fiona.hak/Metappuccino/results_ft_patron_semi/val_metadata_replaced_table.csv'
test_input   = '/store/EQUIPES/SSFA/MEMBERS/fiona.hak/Metappuccino/results_ft_patron_semi/test_metadata_replaced_table.csv'
train_output = '/store/EQUIPES/SSFA/MEMBERS/fiona.hak/Metappuccino/results_ft_final_templates/FINE_TUNING/finetune_data_train_corrected.csv'
val_output   = '/store/EQUIPES/SSFA/MEMBERS/fiona.hak/Metappuccino/results_ft_final_templates/FINE_TUNING/finetune_data_val_corrected.csv'
test_output   = '/store/EQUIPES/SSFA/MEMBERS/fiona.hak/Metappuccino/results_ft_final_templates/FINE_TUNING/finetune_data_test_corrected.csv'
