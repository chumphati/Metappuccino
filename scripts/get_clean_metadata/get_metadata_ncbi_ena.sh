...
PATH="/store/EQUIPES/SSFA/MEMBERS/fiona.hak/Metappuccino/results_train"
...
#     -d "result=read_run&query=${TAX}${STRAT}${DATES}${COUNTS}&format=tsv&fields=run_accession&limit=100" \
