...
metadata_file = '/store/EQUIPES/SSFA/MEMBERS/fiona.hak/MetaMap/data/simulated_metadata.csv'
output_file = '/store/EQUIPES/SSFA/MEMBERS/fiona.hak/MetaMap/results_train/FINE_TUNING_COMPLETE/simulated_ft_data.csv'
