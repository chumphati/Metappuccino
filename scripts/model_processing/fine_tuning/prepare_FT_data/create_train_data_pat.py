...
- cell_type: extract cell type: if known, specify it (e.g., 'T cell'); otherwise, write 'primary tissue'. If the cell type is not directly available, TRY to deduce it from the organ before answering “primary tissue”.
