...
RESULTS_DIR=$METAPPUCCINO/$RES/LLM1
TMP_DIR="$RESULTS_DIR/"
LOG_DIR="$RESULTS_DIR/"

exec > "$LOG_DIR/LLM1.out" \
     2> "$LOG_DIR/LLM1.err"
...
cp "/store/EQUIPES/SSFA/MEMBERS/fiona.hak/Metappuccino/results_rpl25a/ORIGINAL_METADATA/metadata_sra_summarized1.txt"          $SCRATCH_DIR/
...
python3 -u LLM_metadata_inference.py \
  ...
  --input_metadata_path metadata_sra_summarized1.txt \
